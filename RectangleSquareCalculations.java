...
public class RectangleSquareCalculations {
 public static void main(String []arg) {
 	Scanner objectOfScanner=new Scanner(System.in);
 	System.out.println("Enter width and height of rectangle");
 	int widthOfRectangle=objectOfScanner.nextInt();
 	int heightofRectangle=objectOfScanner.nextInt();
 	System.out.println("Enter Side of a square");
 	int sideOfSquare=objectOfScanner.nextInt();
